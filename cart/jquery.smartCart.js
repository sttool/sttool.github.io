...
function gencode(product_desc) {
	if (product_desc == "4000000000001"){
		JsBarcode("#a"+product_desc, "4979006000001");
		JsBarcode("#b"+product_desc, "4979006000002");
		JsBarcode("#c"+product_desc, "4979006000003");
		JsBarcode("#d"+product_desc, "4979006000004");
		JsBarcode("#f"+product_desc, "4979006000005");
		JsBarcode("#g"+product_desc, "4979006000006");
		JsBarcode("#h"+product_desc, "4979006000007");
	}
	else if (product_desc == "4000000000002"){
		JsBarcode("#a"+product_desc, "4979006000001");
		JsBarcode("#b"+product_desc, "4979006000002");
		JsBarcode("#c"+product_desc, "4979006000003");
	}
	else if (product_desc == "4000000000003"){
		JsBarcode("#a"+product_desc, "4979006000005");
		JsBarcode("#b"+product_desc, "4979006000006");
		JsBarcode("#c"+product_desc, "4979006000007");
	}
	else
	{
		JsBarcode("#a"+product_desc, product_desc);
	}
}
...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
		...
		cartItemTemplate:'<img class="barcode" id="a{product_desc}"/><img class="barcode" id="b{product_desc}"/><img class="barcode" id="c{product_desc}"/><img class="barcode" id="d{product_desc}"/><img class="barcode" id="e{product_desc}"/><img class="barcode" id="f{product_desc}"/><img class="barcode" id="g{product_desc}"/><img class="barcode" id="h{product_desc}"/><div class="lastcode"></div><script>gencode({product_desc});</script> <h4 class="list-group-item-heading">{product_name}</h4><p class="list-group-item-text"></p>',
